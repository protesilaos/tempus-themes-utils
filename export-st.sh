...
# Builds all st content files for all items of the Tempus Themes collection
...
for i in $schemes
do
    $generator $i st > $outputdir/tempus_${i}.h
    echo "Preparing to export Tempus $i st (simple terminal) files"
done
